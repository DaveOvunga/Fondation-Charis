        ...
        <div class="hero mb-3">
            ...
            <div class="container px-lg-3 align-items-center">
                <div class="hero-text px-lg-5">
                    ...
                    <div class="mt-3">
                        <a href="<?php echo APP_URL.'/formation/course/'. htmlspecialchars(Helper::encodeIds($data['courseDetail']['id'],$data['listChapitre'][0]['id']))?>/video" class="btn btn-primary begin-course-btn rounded-pill px-4 align-items-center fw-bold">
